        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="adminMrest.php" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Manage Restaurants </a>
                    </li>
                    </li>

                    <li class="nav-item">
                      <a class="nav-link active" href="adminMcustomers.php"
              ...
              <div class="card">
                <h5 class="card-header">All Customer
                 </h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php
                          ...
                          $db = new DBController();
                          $sql = "SELECT * FROM customer where roleid='2'";
                          $result = $db->read($sql);
                      ...
                      <tr>
                        ...
                        <td>
                              <a href='deletecustomer.php?customerid=<?= $row['customerid'] ?>' id='btn' 
